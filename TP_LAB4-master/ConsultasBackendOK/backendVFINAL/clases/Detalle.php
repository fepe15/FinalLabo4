...
public function GuardarDetalle()
{
				...
				$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into pedidodetalle (idPedido, producto, estado, sector, mesaPedido)values(:idPedido, :producto, :estado, :sector, :mesaPedido)");
                $consulta->bindValue(':idPedido', $this->idPedido, PDO::PARAM_INT);
                $consulta->bindValue(':estado', $this->estado, PDO::PARAM_STR);
                $consulta->bindValue(':producto', $this->producto, PDO::PARAM_STR);
                $consulta->bindValue(':sector', $this->sector, PDO::PARAM_STR);
                $consulta->bindValue(':mesaPedido', $this->mesaPedido, PDO::PARAM_STR);
                $consulta->execute();
